export default {
  ...
  tool: {
    ...
    formatHtml: {
      name: 'HTML Formatter',
      desc: 'Beautify and format HTML code',
    ...
    formatJs: {
      ...
      desc: 'Beautify and format JavaScript code',
      indentTab: 'Tab Indent',
      indent2: '2 Spaces',
      indent4: '4 Spaces',
      indent6: '6 Spaces',
    ...
    formatCss: {
      name: 'CSS Formatter',
      desc: 'Beautify and format CSS stylesheets',
      indentTab: 'Tab Indent',
      indent2: '2 Spaces',
      indent4: '4 Spaces',
      indent6: '6 Spaces',
    ...
    formatSql: {
      ...
      btnDownload: 'Download',
      btnClear: 'Clear',
      errorTitle: 'Format Failed',
      errorInvalidSql: 'SQL could not be parsed, please check the syntax',
    },
  },
  setting: {
    title: 'Settings',
